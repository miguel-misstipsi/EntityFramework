...
ORDER BY [t1].[Nickname], [t1].[SquadId], [t1].[Id]");
        ...
        public override void Include_on_derived_type_using_string_without_explicitly_providing_type_throws()
        {
            base.Include_on_derived_type_using_string_without_explicitly_providing_type_throws();
        }
